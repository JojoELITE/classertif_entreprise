        ...
        <div className="flex items-center justify-center gap-9">
          <div>
            ...
            <div className="flex flex-col gap-3 mt-4">
              ...
              <div className="flex gap-3">
                <button
                  className="bg-[#f4f4f4] group-hover:bg-blue-200 group-hover:bg-blue-2000 border text-xs flex gap-1 items-center justify-center px-2 transition-colors"
                >
                  <GraduationCap size={15} color="grey" />
                  Sans diplôme
                </button>
                <button
                  className="bg-[#f4f4f4] group-hover:bg-blue-200 group-hover:bg-blue-2000 border text-xs flex gap-2 items-center justify-center px-2 transition-colors"
                >
